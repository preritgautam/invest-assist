...
import { LenderMatchSection } from "@/components/lender-match-section"
...
export function CapitalTab({ property }: DebtAssumptionsTabProps) {
  ...
  /**
   * Handle loan product selection from lender matching
   * @param product - Selected loan product data
   */
  const handleSelectLoan = (product: any) => {
    // Logic to populate loan card with selected product data
    console.log("Selected loan product:", product)
  }

  /**
   * Handle import button clicks with toast notifications
   * @param source - Name of the import source
   */
  const handleImportClick = (source: string) => {
    toast({
      title: "Coming Soon",
      description: `${source} integration is currently in development.`,
      duration: 3000,
    })
  }
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <Card className="bg-white rounded-2xl shadow-lg border-2 border-white">
        <CardContent className="p-4 sm:p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm sm:text-base font-bold text-gray-900">Imports</h3>
            <Download className="w-4 h-4 text-gray-500" />
          </div>

          {/* Responsive Import Button Layout */}
          {/* Mobile: Stack vertically with full width */}
          <div className="flex flex-col gap-3 sm:hidden">
            <Button
              variant="outline"
              className="w-full h-12 text-sm font-medium bg-gray-50 border-gray-200 hover:bg-gray-100 text-gray-700 justify-start"
              onClick={() => handleImportClick("Pull NOI from OS/RR")}
            >
              <Download className="w-4 h-4 mr-3 flex-shrink-0" />
              <span className="truncate">Pull NOI from OS/RR</span>
            </Button>
            <Button
              variant="outline"
              className="w-full h-12 text-sm font-medium bg-gray-100 border-gray-300 hover:bg-gray-200 text-gray-800 justify-start"
              onClick={() => handleImportClick("Pull DSCR inputs from OS/RR")}
            >
              <Download className="w-4 h-4 mr-3 flex-shrink-0" />
              <span className="truncate">Pull DSCR inputs from OS/RR</span>
            </Button>
            <Button
              variant="outline"
              className="w-full h-12 text-sm font-medium bg-gray-200 border-gray-400 hover:bg-gray-300 text-gray-900 justify-start"
              onClick={() => handleImportClick("Pull Property Info from OM")}
            >
              <Download className="w-4 h-4 mr-3 flex-shrink-0" />
              <span className="truncate">Pull Property Info from OM</span>
            </Button>
          </div>
          ...
          <div className="hidden sm:grid md:hidden grid-cols-2 gap-3">
            <Button
              variant="outline"
              className="h-12 text-sm font-medium bg-gray-50 border-gray-200 hover:bg-gray-100 text-gray-700 justify-start px-4"
              onClick={() => handleImportClick("Pull NOI from OS/RR")}
            >
            ...
            <Button
              variant="outline"
              className="h-12 text-sm font-medium bg-gray-100 border-gray-300 hover:bg-gray-200 text-gray-800 justify-start px-4"
              onClick={() => handleImportClick("Pull DSCR inputs from OS/RR")}
            >
              <Download className="w-4 h-4 mr-2 flex-shrink-0" />
              <span className="truncate">Pull DSCR inputs</span>
            </Button>
            <Button
              variant="outline"
              className="h-12 text-sm font-medium bg-gray-200 border-gray-400 hover:bg-gray-300 text-gray-900 justify-start px-4 col-span-2"
              onClick={() => handleImportClick("Pull Property Info from OM")}
            >
              <Download className="w-4 h-4 mr-2 flex-shrink-0" />
              <span className="truncate">Pull Property Info from OM</span>
          ...
          <div className="hidden md:flex gap-4">
            <Button
              variant="outline"
              className="flex-1 h-10 text-sm font-medium bg-gray-50 border-gray-200 hover:bg-gray-100 text-gray-700 justify-start px-4"
              onClick={() => handleImportClick("Pull NOI from OS/RR")}
            >
              <Download className="w-4 h-4 mr-2 flex-shrink-0" />
              <span className="truncate">Pull NOI from OS/RR</span>
            ...
            <Button
              variant="outline"
              className="flex-1 h-10 text-sm font-medium bg-gray-100 border-gray-300 hover:bg-gray-200 text-gray-800 justify-start px-4"
              onClick={() => handleImportClick("Pull DSCR inputs from OS/RR")}
            >
              <Download className="w-4 h-4 mr-2 flex-shrink-0" />
              <span className="truncate">Pull DSCR inputs from OS/RR</span>
            ...
            <Button
              variant="outline"
              className="flex-1 h-10 text-sm font-medium bg-gray-200 border-gray-400 hover:bg-gray-300 text-gray-900 justify-start px-4"
              onClick={() => handleImportClick("Pull Property Info from OM")}
            >
              <Download className="w-4 h-4 mr-2 flex-shrink-0" />
              <span className="truncate">Pull Property Info from OM</span>
      ...
      {/* Lender Match Integration */}
      <LenderMatchSection onSelectLoan={handleSelectLoan} />
    </div>
  )
}
